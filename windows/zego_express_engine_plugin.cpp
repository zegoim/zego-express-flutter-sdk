...
std::map<std::string, std::function<void(flutter::EncodableMap& argument,
       ...
       {"isFeatureSupported", std::bind(&ZegoExpressEngineMethodHandler::isFeatureSupported, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       ...
       {"getAssetAbsolutePath", std::bind(&ZegoExpressEngineMethodHandler::getAssetAbsolutePath, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       ...
       {"enableAlignedAudioAuxData", std::bind(&ZegoExpressEngineMethodHandler::enableAlignedAudioAuxData, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       ...
       {"takePlayStreamSnapshot", std::bind(&ZegoExpressEngineMethodHandler::takePlayStreamSnapshot, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       ...
       {"setMixSystemPlayoutVolume", std::bind(&ZegoExpressEngineMethodHandler::setMixSystemPlayoutVolume, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"enableMixEnginePlayout", std::bind(&ZegoExpressEngineMethodHandler::enableMixEnginePlayout, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"enableMixSystemPlayout", std::bind(&ZegoExpressEngineMethodHandler::enableMixSystemPlayout, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       ...
       {"startAudioDeviceVolumeMonitor", std::bind(&ZegoExpressEngineMethodHandler::startAudioDeviceVolumeMonitor, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"stopAudioDeviceVolumeMonitor", std::bind(&ZegoExpressEngineMethodHandler::stopAudioDeviceVolumeMonitor, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"muteAudioDevice", std::bind(&ZegoExpressEngineMethodHandler::muteAudioDevice, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"isAudioDeviceMuted", std::bind(&ZegoExpressEngineMethodHandler::isAudioDeviceMuted, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"setAudioDeviceMode", std::bind(&ZegoExpressEngineMethodHandler::setAudioDeviceMode, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       ...
       {"useVideoDevice", std::bind(&ZegoExpressEngineMethodHandler::useVideoDevice, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"getVideoDeviceList", std::bind(&ZegoExpressEngineMethodHandler::getVideoDeviceList, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"getDefaultVideoDeviceID", std::bind(&ZegoExpressEngineMethodHandler::getDefaultVideoDeviceID, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"enableMixSystemPlayout", std::bind(&ZegoExpressEngineMethodHandler::enableMixSystemPlayout, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"startAudioVADStableStateMonitor", std::bind(&ZegoExpressEngineMethodHandler::startAudioVADStableStateMonitor, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"stopAudioVADStableStateMonitor", std::bind(&ZegoExpressEngineMethodHandler::stopAudioVADStableStateMonitor, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       {"getCurrentAudioDevice", std::bind(&ZegoExpressEngineMethodHandler::getCurrentAudioDevice, &ZegoExpressEngineMethodHandler::getInstance(), std::placeholders::_1, std::placeholders::_2)},
       // Audio Effect Player
