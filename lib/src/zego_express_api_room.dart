...
extension ZegoExpressEngineRoom on ZegoExpressEngine {
  ...
  /// Description: After the user in the room calls this function to set the extra info of the room, other users in the same room will be notified through the [onRoomExtraInfoUpdate] callback function.
