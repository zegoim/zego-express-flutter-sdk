...
extension ZegoExpressEnginePublisher on ZegoExpressEngine {
  ...
  /// Deletes the specified CDN URL, which is used for relaying streams to CDN from ZEGO's cloud streaming server.
  ///
  ...
  /// Sends supplemental enhancement information (SEI) for the specified channel.
  ///
  ...
  /// Sets the timing of video scaling in the video capture workflow. You can choose to do video scaling right after video capture (default value) or before encoding.
  ///
