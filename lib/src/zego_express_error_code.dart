...
class ZegoErrorCode {
  ...
  /// already called setEventHandler to set the handle, please do not repeat the setting, if you need to repeat the setting, please first call setEventHandler to set the previous handle null.
  ...
  /// enable/disable custom video capture/render failed. please make sure to call before engine start. (make sure to call before startPreview/startPublishingStream/startPlayingStream)
