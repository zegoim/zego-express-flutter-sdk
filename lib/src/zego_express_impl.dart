      ...
      case 'onPublisherQualityUpdate':
        ...
        ZegoExpressEngine.onPublisherQualityUpdate!(
          ...
          ZegoPublishStreamQuality(
            ...
            map['rtt'],
            map['packetLostRate'],
            ZegoStreamQualityLevel.values[map['level']],
            map['isHardwareEncode'],
            ZegoVideoCodecID.values[map['videoCodecID']],
            map['totalSendBytes'],
            map['audioSendBytes'],
            map['videoSendBytes'],
          )
      ...
      case 'onPlayerQualityUpdate':
        ...
        ZegoExpressEngine.onPlayerQualityUpdate!(
          ...
          ZegoPlayStreamQuality(
            map['videoRecvFPS'],
            map['videoDejitterFPS'],
            map['videoDecodeFPS'],
            map['videoRenderFPS'],
            map['videoKBPS'],
            map['videoBreakRate'],
            map['audioRecvFPS'],
            map['audioDejitterFPS'],
            map['audioDecodeFPS'],
            map['audioRenderFPS'],
            map['audioKBPS'],
            map['audioBreakRate'],
            ...
            map['packetLostRate'],
            map['peerToPeerDelay'],
            map['peerToPeerPacketLostRate'],
            ZegoStreamQualityLevel.values[map['level']],
            map['delay'],
            map['avTimestampDiff'],
            map['isHardwareDecode'],
            ZegoVideoCodecID.values[map['videoCodecID']],
            map['totalRecvBytes'],
            map['audioRecvBytes'],
            map['videoRecvBytes']
