...
class ZegoCanvas {
  ...
  ZegoCanvas.view(this.view): this.viewMode = ZegoViewMode.AspectFit, this.backgroundColor = 0x000000, this.alphaBlend = false;
...
class ZegoPlayerConfig {
  ...
  ZegoPlayerConfig.defaultConfig() : resourceMode = ZegoStreamResourceMode.Default, videoCodecID = ZegoVideoCodecID.Unknown, sourceResourceType = ZegoResourceType.RTC, codecTemplateID = 0, resourceSwitchMode = ZegoStreamResourceSwitchMode.Default;
...
class ZegoMixerAudioConfig {
  ...
  ZegoMixerAudioConfig.defaultConfig() : bitrate = 48, channel = ZegoAudioChannel.Mono, codecID = ZegoAudioCodecID.Normal, mixMode = ZegoAudioMixMode.Raw;
...
class ZegoMixerVideoConfig {
  ...
  ZegoMixerVideoConfig.defaultConfig() : width = 360, height = 640, fps = 15, bitrate = 600, quality = 32, rateControlMode = ZegoVideoRateControlMode.ConstantRate;
...
class ZegoMixerOutputVideoConfig {
  ...
  ZegoMixerOutputVideoConfig(this.videoCodecID, this.bitrate, {this.encodeProfile = ZegoEncodeProfile.Default, this.encodeLatency = 0, this.enableLowBitrateHD = false});
...
class ZegoMixerInput {
  ...
  ZegoMixerInput(this.streamID, this.contentType, this.layout, this.soundLevelID, this.volume, this.isAudioFocus, this.audioDirection, {this.label, this.renderMode, this.imageInfo, this.cornerRadius, this.advancedConfig});
...
class ZegoMixerWhiteboard {
  ...
  ZegoMixerWhiteboard.defaultConfig() : whiteboardID = 0, horizontalRatio = 16, verticalRatio = 9, isPPTAnimation = false, layout = Rect.zero, zOrder = 0, backgroundColor = 0xF1F3F400;
...
class ZegoMixerTask {
  ...
  ZegoMixerTask(this.taskID) : inputList = [], outputList = [], audioConfig = ZegoMixerAudioConfig.defaultConfig(), videoConfig = ZegoMixerVideoConfig.defaultConfig(), watermark = ZegoWatermark('', const Rect.fromLTRB(0, 0, 0, 0)), whiteboard= ZegoMixerWhiteboard.defaultConfig(), backgroundColor = 0, backgroundImageURL = "", enableSoundLevel = false, streamAlignmentMode = ZegoStreamAlignmentMode.None, userData = Uint8List.fromList([]), advancedConfig = {}, minPlayStreamBufferLength = -1;
...
class ZegoAutoMixerTask {
  ...
  ZegoAutoMixerTask() : taskID = "", roomID = "", outputList = [], audioConfig = ZegoMixerAudioConfig.defaultConfig(), enableSoundLevel = false, minPlayStreamBufferLength = -1;
...
class ZegoRoomSendTransparentMessage {
  ...
  ZegoRoomSendTransparentMessage(this.sendMode, this.sendType, this.content, this.recvUserList, this.timeOut);
...
class ZegoCustomAudioProcessConfig {
  ...
  ZegoCustomAudioProcessConfig.defaultConfig() : this.sampleRate = ZegoAudioSampleRate.Unknown, this.channel = ZegoAudioChannel.Unknown, this.samples = 0;
...
class ZegoCopyrightedMusicRequestConfigV2 {
  ...
  ZegoCopyrightedMusicRequestConfigV2(this.songID, this.mode, {this.vendorID, this.roomID, this.masterID, this.sceneID, this.resourceType});
...
class ZegoCopyrightedMusicGetSharedConfigV2 {
  ...
  ZegoCopyrightedMusicGetSharedConfigV2(this.songID, {this.vendorID, this.roomID, this.resourceType});
...
class ZegoCopyrightedMusicQueryCacheConfigV2 {
  ...
  ZegoCopyrightedMusicQueryCacheConfigV2(this.songID, {this.resourceType, this.resourceQualityType, this.vendorID});
...
class ZegoScreenCaptureConfig {
  ...
  ZegoScreenCaptureConfig.defaultConfig() : captureVideo = true, captureAudio = true, microphoneVolume = 100, applicationVolume = 100, audioParam = ZegoAudioFrameParam(ZegoAudioSampleRate.SampleRate16K, ZegoAudioChannel.Stereo);
...
class ZegoMediaPlayerResource {
  ...
  ZegoMediaPlayerResource.defaultConfig() : loadType = ZegoMultimediaLoadType.FilePath, startPosition = 0, alphaLayout = ZegoAlphaLayoutType.None, filePath = '', memory = Uint8List.fromList([]), resourceID= '';
...
class ZegoBackgroundConfig {
  ...
  ZegoBackgroundConfig.defaultConfig() : processType = ZegoBackgroundProcessType.Transparent, color = 0, imageURL = '', videoURL = '', blurLevel = ZegoBackgroundBlurLevel.Medium;
...
class ZegoObjectSegmentationConfig {
  ...
  /// Constructs a background image configuration object by default.
  ZegoObjectSegmentationConfig.defaultConfig() : objectSegmentationType = ZegoObjectSegmentationType.AnyBackground, backgroundConfig = ZegoBackgroundConfig.defaultConfig();
...
class ZegoMediaPlayerMediaInfo {
  ...
  ZegoMediaPlayerMediaInfo.defaultInfo() : width = 0, height = 0, frameRate = 0;
...
class ZegoMediaPlayerStatisticsInfo {
  ...
  ZegoMediaPlayerStatisticsInfo(this.videoSourceFps, this.videoDecodeFps, this.videoRenderFps, this.audioSourceFps, this.audioDecodeFps, this.audioRenderFps);

  /// Constructs a media player play statistics object by default.
  ZegoMediaPlayerStatisticsInfo.defaultParam() : videoSourceFps = 0, videoDecodeFps = 0, videoRenderFps = 0, audioSourceFps = 0, audioDecodeFps = 0, audioRenderFps = 0;
...
class ZegoReceiveRangeParam {
  ...
  ZegoReceiveRangeParam.defaultParam() : min = 0, max = 0;
...
class ZegoVocalRangeParam {
  ...
  ZegoVocalRangeParam.defaultParam() : min = 0, max = 0;
...
class ZegoColorEnhancementParams {
  ...
  ZegoColorEnhancementParams(this.intensity, this.skinToneProtectionLevel, this.lipColorProtectionLevel);

  /// Constructs a color enhancement params object by default.
  ZegoColorEnhancementParams.defaultParam() : intensity = 0, skinToneProtectionLevel = 1, lipColorProtectionLevel = 0;
...
abstract class ZegoCopyrightedMusic {
  ...
  Future<ZegoCopyrightedMusicGetLrcLyricResult> getLrcLyricWithConfig(ZegoCopyrightedMusicGetLyricConfig config);
  ...
  /// - [config] The configuration of requesting music resource.
  /// - Returns Result of requesting music resource.
  Future<ZegoCopyrightedMusicRequestResourceResult> requestResourceV2(ZegoCopyrightedMusicRequestConfigV2 config);
  ...
  /// - [config] The configuration of getting shared music resource.
  /// - Returns Result of getting shared music resource.
  Future<ZegoCopyrightedMusicGetSharedResourceResult> getSharedResourceV2(ZegoCopyrightedMusicGetSharedConfigV2 config);
  ...
  ///
  /// - [config] The configuration of querying cache.
  Future<bool> queryCacheWithConfigV2(ZegoCopyrightedMusicQueryCacheConfigV2 config);
