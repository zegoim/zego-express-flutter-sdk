...
class ZegoPlayerConfig {
  ...
  ZegoPlayerConfig(this.resourceMode, {this.cdnConfig, this.roomID, this.videoCodecID, this.sourceResourceType, this.codecTemplateID});

  /// Create a default advanced player config object
  ZegoPlayerConfig.defaultConfig() : resourceMode = ZegoStreamResourceMode.Default, videoCodecID = ZegoVideoCodecID.Unknown, sourceResourceType = ZegoResourceType.RTC, codecTemplateID = 0;
...
class ZegoMixerWhiteboard {
  ...
  ZegoMixerWhiteboard(this.whiteboardID, this.horizontalRatio, this.verticalRatio, this.isPPTAnimation, this.layout, this.zOrder);

  /// Create a mixer whiteboard object
  ZegoMixerWhiteboard.defaultConfig() : whiteboardID = 0, horizontalRatio = 16, verticalRatio = 9, isPPTAnimation = false, layout = Rect.zero, zOrder = 0;
...
class ZegoAutoMixerTask {
  ...
  ZegoAutoMixerTask() : taskID = "", roomID = "", outputList = [], audioConfig = ZegoMixerAudioConfig.defaultConfig(), enableSoundLevel = false {
    taskID = "";
    roomID = "";
    outputList = [];
...
class ZegoCopyrightedMusicRequestConfig {
  ...
  ZegoCopyrightedMusicRequestConfig(this.songID, this.mode, {this.vendorID, this.roomID, this.masterID});
...
class ZegoScreenCaptureConfig {
  ...
  ZegoScreenCaptureConfig(this.captureVideo, this.captureAudio, this.microphoneVolume, this.applicationVolume);
