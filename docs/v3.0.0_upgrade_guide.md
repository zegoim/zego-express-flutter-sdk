...
- [General], [Communication], and [Live] three scenarios in [ZegoScenario](https://pub.dev/documentation/zego_express_engine/latest/zego_express_engine/ZegoScenario.html) scenario enumeration are discarded. For details, please refer to [Scenario Audio and video configuration](https://doc-zh.zego.im/article/16870) document for adaptation.
