...
class ZegoTextureRendererController : public ZEGO::EXPRESS::IZegoCustomVideoRenderHandler,
  ...
  public:
    ...
    inline void setEventSink(FTEventSink &&eventSink) { eventSink_ = std::move(eventSink); }
  ...
  public:
    void sendScreenCapturedVideoFrameRawData(unsigned char **data, unsigned int *dataLength,
  ...
  protected:
    ...
    virtual void onCapturedVideoFrameRawData(unsigned char **data, unsigned int *dataLength,
                                             ZEGO::EXPRESS::ZegoVideoFrameParam param,
                                             ZEGO::EXPRESS::ZegoVideoFlipMode flipMode,
    ...
    virtual void onRemoteVideoFrameEncodedData(const unsigned char *data, unsigned int dataLength,
...
class ZegoTextureRendererControllerEventChannel
  ...
  protected:
    ...
    OnListenInternal(const flutter::EncodableValue *arguments, FTEventSink &&events) override {
